{include file='modules_header.tpl'}
  ...
  <form action="{$same_page}" method="post" onsubmit="return rsv.validate(this, rules)">
    ...
    <tr>
      ...
      <td><input type="text" name="field_label" style="width:589px" value="{$field_info.field_label|escape}" /></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input type="text" name="default_value" style="width:589px" value="{$field_info.default_value|escape}" /></td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        ...
        <tr>
          ...
          <td align="right"><input type="text" name="error_string" style="width:490px" value="{$field_info.error_string|escape}" /></td>
        </tr>
        </table>
      </td>
    </tr>
    ...
    <div id="field_options_div" {if $field_info.field_type == "textbox" || $field_info.field_type == "textarea" || $field_info.field_type == "password"}style="display:none"{/if}>
